...
<div style="clear: both;">
  ...
  <div>
    ...
    <span style="font-size:1.2rem;">이희도</span>
    <span style="color:orange; font-size:1.5rem; display : block;">Now.</span>
    <span style="font-size:1.2rem;">사회복무요원하면서 개발공부</span>
    ...
    <span style="color:orange; font-size:1.5rem; display : block;">Hobby.</span>
    <span style="font-size:1.2rem;">싸이클, 낚시, 변수명 짓기, 뻘짓하기</span>
